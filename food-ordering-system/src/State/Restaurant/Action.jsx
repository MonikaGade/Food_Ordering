    ...
    return async (dispatch)=>{
        ...
        try{
           ...
           console.log('restaurant',data);
            ...
            console.log('catch error in rest',error);
...
export const createRestaurant=(reqData)=>{
    ...
    return async (dispatch)=>{
        ...
        try{
            const response=await api.get(`api/admin/restaurants`,reqData.data,
            {
                headers:{
...
export const deleteEventAction=({eventId,jwt})=>{
    return async (dispatch)=>{
        dispatch({type:DELETE_RESTAURANT_REQUEST});
        try{
            const res=await api.delete(`api/admin/evenets/${eventId}`,
            {
                headers:{
                    Authorization:`Bearer ${jwt},`
                },
...
export const getRestaurantsCategory=({jwt,restaurantId})=>{
    return async (dispatch)=>{
        ...
        try{
            ...
            dispatch({type:GET_RESTAURANTS_CATEGORY_REQUEST,payload:res.data})
        }catch(error){
            console.log(error);
