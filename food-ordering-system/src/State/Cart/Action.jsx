...
export const updateCartItem=(reqData)=>{
    return async (dispatch)=>{
        ...
        try{
            const response=await api.get(`/api/cart-item/update`,reqData.data,{
                headers:{
...
export const removeCartItem=({cartItemId,jwt})=>{
    return async (dispatch)=>{
        ...
        try{
            const response=await api.get(`/api/cart-item/${cartItemId}/remove`,{
                headers:{
...
export const clearCartAction=()=>{
    return async (dispatch)=>{
        ...
        try{
            const response=await api.get(`/api/cart/clear`,{},{
                headers:{
